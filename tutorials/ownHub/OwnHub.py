...
class OwnHub(j.application.JSBaseClass):
    ...
    def run(self):
        ...
        ownhub_instance = input(self.CBOLD + self.CWHITE2 + "Do you have an instance of ownhub (y/[n])? ")
    ...
    def _ownhub_local(self):
        ...
        container_ip = input(self.CBOLD + self.CWHITE2 + "Please input your container ip: ")
    ...
    def _builder_example(self):
        ...
        odoo_ip = input(self.CBOLD + self.CWHITE2 + "Please input your container ip: ")
        ...
        # 3- Install Odoo
        input(self.CBOLD + self.CWHITE2 + "Press ENTER to continue the next part: (Installation)... ")
